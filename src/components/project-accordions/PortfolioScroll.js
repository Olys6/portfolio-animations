...
const PortfolioScroll = () => {
    ...
    return (
        <Accordion className="projectAccordion" sx={{ minHeight: "20rem", transition: ".3s", backgroundImage: expandedBrightness, backgroundSize: "cover", backgroundPosition: "center", marginBottom: "0 !important" }} expanded={expanded === 'panel'} onChange={handleChange('panel')}>
            ...
            >
                <Typography sx={{ fontWeight: "bold", backgroundImage: "linear-gradient(90deg, #08d404 50%, rgba(0,0,0,0) 50%, rgba(0,0,0,0) 0), #ffbc34;", backgroundSize: "75px", backgroudPosition: "center", borderRadius: "4px", padding: "3px" }} color='secondary' variant="h5" >Animations Portfolio</Typography>
            </AccordionSummary>
            <AccordionDetails>
